...
namespace Camping.Views.Articles
{
    ...
    public partial class ArticleExpertViewPage : ContentPage
    {
        public ArticleExpertViewPage() : this(new ArticleViewModel())
		{

        }

        public ArticleExpertViewPage(ArticleViewModel viewModel)
        {
           
            InitializeComponent();
            viewModel.Id_Lo_description = 5;
