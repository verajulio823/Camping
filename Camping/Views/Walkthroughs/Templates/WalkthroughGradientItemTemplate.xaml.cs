...
namespace Camping
{
	public partial class WalkthroughGradientItemTemplate : ContentPage
	{
		public static BindableProperty TextProperty =
			BindableProperty.Create(
				nameof(Text),
				typeof(string),
				typeof(WalkthroughGradientItemTemplate),
				string.Empty,
				defaultBindingMode: BindingMode.OneWay,
				propertyChanged: (bindable, oldValue, newValue) =>
				{
					var ctrl = (WalkthroughGradientItemTemplate)bindable;
		...
		public WalkthroughGradientItemTemplate()
		{
			InitializeComponent();
